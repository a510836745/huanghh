...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/adminOrder.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/templatemo-script.js"></script>
    ...
    <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
            ...
            <c:forEach items="${pageInfo.list}" var="orderInfo">
                <div class="templatemo-flex-row flex-content-row" name="parent">
                    <div class="col-1">
                                    ...
                                    <div class="order-info margin-bottom-10">
                                        ...
                                        <div>
                                            <table id="orderinfo" class="table table-striped table-bordered templatemo-user-table goods-table">
                                                ...
                                                <tbody>
                                                <tr>
                                                    <td name="ROrderId">${orderInfo.orderid}</td>
                                        ...
                                        <div>
                                            <table id="goodsinfo" class="table table-striped table-bordered templatemo-user-table goods-table">
                                                ...
                                                <c:forEach items="${orderInfo.goodsInfo}" var="goods">
                                                    <tr>
                                                        <td id="RGoodsId">${goods.goodsid}</td>
                                                        <td>${goods.goodsname}</td>
                                                        <td>￥${goods.price}</td>
                                                        <td>${goods.num}</td>
                                                        <td><a href="${pageContext.request.contextPath}/detail?goodsid=${goods.goodsid}" class="templatemo-link">详情</a></td>
                                                        <c:if test="${goods.isRefund == 2}">
                                                            <td><button class="templatemo-blue-button finish-btn" name="confirmRefund">确认退货</button></td>
<%--                                                            <td><a href="${pageContext.request.contextPath}/admin/order/confirmRefund?orderid=${orderInfo.orderid}/goodsid=${goods.goodsid}" class="templatemo-link">确认退货</a></td>--%>
                                                        </c:if>
                                                        <c:if test="${goods.isRefund == 3}">
                                                            <td>已退货</td>
                                                        </c:if>
                                                    </tr>
                                                </c:forEach>
            ...
            <div class="pagination-wrap" id="page-div-nav">
                ...
                <ul class="pagination">
                    <li>
                        <a href="${pageContext.request.contextPath}/admin/order/refund?page=1" aria-label="Next">
                    ...
                    <c:if test="${pageInfo.hasPreviousPage}">
                        <li>
                            <a href="${pageContext.request.contextPath}/admin/order/refund?page=${pageInfo.pageNum - 1}" aria-label="Previous">
                    ...
                    <c:forEach items="${pageInfo.navigatepageNums}" var="pageNums">
                        <c:if test="${pageNums == pageInfo.pageNum}">
                            <li class="active"><a href="${pageContext.request.contextPath}/admin/order/refund?page=${pageNums}">${pageNums}</a></li>
                        </c:if>
                        <c:if test="${pageNums != pageInfo.pageNum}">
                            <li><a href="${pageContext.request.contextPath}/admin/order/refund?page=${pageNums}">${pageNums}</a></li>
                        </c:if>
                    </c:forEach>

                    <c:if test="${pageInfo.hasNextPage}">
                        <li>
                            <a href="${pageContext.request.contextPath}/admin/order/refund?page=${pageInfo.pageNum + 1}" aria-label="Next">
                                <span aria-hidden="true"><i class="fa fa-forward"></i></span>
                            </a>
                        </li>
                    </c:if>
                    <li>
                        <a href="${pageContext.request.contextPath}/admin/order/refund?page=${pageInfo.pages}" aria-label="Next">
